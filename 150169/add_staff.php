            ...
            <form action="save_staff.php" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3 text-center">
                        ...
                        <div class="status-toggle">
                            <input type="radio" name="work_status" id="work_y" value="Y" checked onclick="toggleEndDate()">
                            <label for="work_y" class="lab-yes">✅ ปฏิบัติงาน</label>
                            <input type="radio" name="work_status" id="work_n" value="N" onclick="toggleEndDate()">
