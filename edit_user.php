...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $log_pass_msg = ""; // ข้อความเสริมสำหรับ Log
    ...
    if (!empty($new_password)) {
        ...
        $log_pass_msg = " และรีเซ็ตรหัสผ่านใหม่";
    } else {
        // ถ้าไม่กรอกรหัสผ่าน
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        // ✅ --- บันทึก LOG เมื่อแก้ไขผู้ใช้งานสำเร็จ ---
        $details = "แก้ไขข้อมูลผู้ใช้งาน: " . $user['username'] . " (ชื่อ: $full_name, สิทธิ์: $role)" . $log_pass_msg;
        write_log($conn, 'EDIT', 'sys_users', $id, $details);
        // ------------------------------------------
